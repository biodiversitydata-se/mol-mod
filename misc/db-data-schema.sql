...
CREATE TABLE IF NOT EXISTS public.dataset (
    dataset_id character varying PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.sampling_event (
    ...
    dataset_id character varying REFERENCES public.dataset(dataset_id) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mixs (
    event_id character varying PRIMARY KEY REFERENCES public.sampling_event(event_id),
...
CREATE TABLE IF NOT EXISTS public.emof (
    measurement_id character varying PRIMARY KEY,
    ...
    event_id character varying NOT NULL REFERENCES public.sampling_event(event_id),
...
CREATE TABLE IF NOT EXISTS public.asv (
    asv_id character(36) PRIMARY KEY,
    asv_sequence character varying NOT NULL
);

CREATE TABLE IF NOT EXISTS public.occurrence (
    occurrence_id character varying PRIMARY KEY,
    event_id character varying REFERENCES public.sampling_event(event_id) NOT NULL,
    asv_id character(36) REFERENCES public.asv(asv_id) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.taxon_annotation (
    annotation_id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    asv_id  character(36) REFERENCES public.asv(asv_id) NOT NULL,
