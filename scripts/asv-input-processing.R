...
# ASVs NOT predicted to be target gene e.g. 16S by Barrnap AND having kingdom=Unassigned
...
# Rename dataframes as '-' is not allowed in R
asv_table <- `asv-table`
rm(`asv-table`)
...
if (exists('non_target')){
  # Remove any ASVs listed as non-target from asv-table and annotation tabs
